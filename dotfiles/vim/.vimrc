...
" AUTOMATED SETUP: Check for Vundle and install if missing
let iCanHazVundle=1
...
" AUTOMATED SETUP: Create backup directory if it doesn't exist
...
" If Vundle was just installed, install the plugins mentioned above
if iCanHazVundle == 0
...
" from benji fisher to turn on the matchit plugin automatically and 
filetype plugin on
...
" evil, bad!
" -- hard tabs should be 8 chars... --lindes
" set tabstop=4
